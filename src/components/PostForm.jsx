  ...
  return (
    <div className="w-full mx-auto">
      <div className="w-full max-w-[700px] p-2">
        ...
        <form className="mt-4 space-y-2" onSubmit={onSubmithandler()}>
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-around">
            <Button onClick={handleSubmit(onSubmithandler())}>{JobData ? "Edit Document" : "Add document"}</Button>
            {JobData && <Button>Delete document</Button>}
          </div>
        </form>
      </div>
    </div>
