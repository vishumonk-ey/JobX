  ...
  return (
    <div className="w-full flex items-center justify-center">
      <div className="w-full max-w-lg bg-indigo-200 flex flex-col items-center p-10 rounded-lg">
        ...
        <form onSubmit={handleSubmit(SignupHandler)} className="mt-4"></form>
        ...
        <div className="w-full mt-2 flex items-center space-x-3">
          ...
          onClick={googleAuthHandler}>
            ...
            Google</Button>
          <Button className="flex-1 flex items-center justify-center" onClick={githubAuthHandler}><GithubIcon className="w-5 h-5 mr-1"/>Github</Button>
        </div>
      </div>
    </div>
  );
